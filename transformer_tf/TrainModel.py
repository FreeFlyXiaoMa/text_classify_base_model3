...
from Transformer import Muti_head_Attention
    ...
    def trainModel(self, embedding_dim=200,
        ...
        with tf.Graph().as_default():
            ...
            with tf.name_scope("readfile"):
                ...
                articles, tags = processing.loadPracticeFile('/E/home/mayajun/PycharmProjects/text_classify_base_model/data/train_sentiment.txt')
            ...
            # 加载词典
            vocab = learn.preprocessing.VocabularyProcessor.restore('./save/vocab.pickle')
            ...
            with sess.as_default():
                ...
                for time in range(config.epoch):
                    ...
                    if f1_scores > best_f1:
                        best_f1 = f1_scores
                        saver.save(sess, "./save/transformerModel.ckpt")
                        print("saved\n")
