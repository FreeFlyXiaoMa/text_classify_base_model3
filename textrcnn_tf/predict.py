...
from textrcnn_tf.data_helper import load_json, padding


class Predict():
    def __init__(self, config, model_path='./runs/1574763898/checkpoints/model-200', word_to_index='./vocabs/word_to_index.json',
