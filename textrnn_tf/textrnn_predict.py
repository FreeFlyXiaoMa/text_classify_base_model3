...
dicts = {}
with open("/E/home/mayajun/PycharmProjects/text_classify_base_model/data/labels.txt", 'r', encoding="utf-8") as f:
...
class Infer(object):
    ...
    def infer(self, sentences):
        vocab_processor = learn.preprocessing.VocabularyProcessor.restore('save/vocab.pickle')
        checkpoint_file = tf.train.latest_checkpoint('./save')
