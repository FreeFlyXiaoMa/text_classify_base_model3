...
parser.add_argument('-epochs', type=int, default=3, help='number of epochs for train [default: 20]')
...
parser.add_argument('-sequence-length',type=int,default=128,help='the length of input sentence [default 16]')
